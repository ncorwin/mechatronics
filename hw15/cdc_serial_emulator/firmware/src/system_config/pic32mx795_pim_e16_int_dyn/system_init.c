...
// DEVCFG3
#pragma config USERID = 64417 // some 16bit userid, doesn't matter what
...
void SYS_Initialize ( void *data )
{
    ...
    RPB15Rbits.RPB15R = 0b0101; //Pin B15 = motor 1 PWM
    TRISBbits.TRISB13 = 0;      //Pin B13 = motor 1 dir 
    ...
    RPB8Rbits.RPB8R = 0b0101;   //Pin B8 = motor 2 PWM
    TRISBbits.TRISB9 = 0;      //Pin B9 = motor 2 dir 
